    ...
    <div id="option" :class="[show && 'optionHide']">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <button @click="RandomXiaoxingxing(0)">0</button>&nbsp;|&nbsp;<button @click="RandomXiaoxingxing(1200)">
              100</button
            >&nbsp;|&nbsp;<button @click="RandomXiaoxingxing(2400)">200</button>&nbsp;|&nbsp;<button
              @click="RandomXiaoxingxing(3600)"
            >
              400
            </button>
          </td>
        ...
        <tr>
          ...
          <td>
            <button @click="RandomPosition()">click</button>
          </td>
        </tr>
      </table>
    </div>
