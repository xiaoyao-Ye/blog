...
function changeBgColor(e) {
  ...
  document.getElementsByClassName('taiyangxi')[0].style.backgroundColor = color
...
// TODO:
// loading: https://codepen.io/Siddharth11/pen/xbGrpG
// Solar system: https://github.com/T-miracle/Solar-system
// Solar system: T-miracle.github.io/Solar-system/
// lively Wallpaper
</script>
...
<template>
  <div>
    ...
    <div class="taiyangxi">
      ...
      <div class="taiyang" />
      <!-- 水星 -->
      <div class="shuixing-guidao" />
      <div class="shuixing-xitong">
        <div class="shuixing" />
      </div>
      <!-- 金星 -->
      <div class="jinxing-guidao" />
      <div class="jinxing-xitong">
        <div class="jinxing" />
      </div>
      <!-- 地月系统 -->
      <div class="diqiu-guidao" />
      ...
      <!-- 木星 -->
      <div class="muxing-guidao" />
      <div class="muxing-xitong">
        <div class="muxing" />
      </div>
      <!-- 木星 -->
      <div class="tuxing-guidao" />
      <div class="tuxing-xitong">
        <div class="tuxing" />
        <div class="ring" />
      </div>
      <!-- 天王星 -->
      <div class="tianwangxing-guidao" />
      <div class="tianwangxing-xitong">
        <div class="tianwangxing" />
      </div>
      <!-- 海王星 -->
      <div class="haiwangxing-guidao" />
      <div class="haiwangxing-xitong">
        <div class="haiwangxing" />
      </div>
    </div>

    <div id="optionBtn" :class="[show && 'optionBtnHide']" @click="popUp">
      <svg
        t="1581348631156" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        p-id="1959" width="32" height="32"
      >
        <path
          ...
          p-id="1960" fill="#ffffff"
        />
      </svg>
    </div>

    <!-- 选项面板 -->
    <div id="option" :class="[show && 'optionHide']">
      <input id="language" type="button" value="EN" @click="changeLanguage(this)">
      <table>
        <tr>
          <td class="zh">
            背景颜色
        ...
        <tr>
          ...
          <td>
            <button @click="RandomXiaoxingxing(0)">
              0
            </button>&nbsp;|&nbsp;<button @click="RandomXiaoxingxing(1200)">
              100
            </button>&nbsp;|&nbsp;<button @click="RandomXiaoxingxing(2400)">
              200
            </button>&nbsp;|&nbsp;<button @click="RandomXiaoxingxing(3600)">
              400
            </button>
          </td>
        </tr>
...
.muxing {
  ...
  background: radial-gradient(#2a2a2a 0%,
      #79694f 20%,
      #7a7467 30%,
      #7f6244 35%,
      #c3d1d1 37%,
