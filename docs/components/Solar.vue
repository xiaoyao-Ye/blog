    ...
    <div id="option">
      ...
      <table>
        ...
        <tr>
          ...
          <td>
            <button onclick="RandomXiaoxingxing(0)">0</button>&nbsp;|&nbsp;<button onclick="RandomXiaoxingxing(1200)">
              100</button
            >&nbsp;|&nbsp;<button onclick="RandomXiaoxingxing(2400)">200</button>&nbsp;|&nbsp;<button
              onclick="RandomXiaoxingxing(3600)"
            >
              400
            </button>
          </td>
...
onMounted(() => {
  ...
  function changeBgColor(color) {
    document.getElementsByClassName('taiyangxi')[0].style.backgroundColor =
